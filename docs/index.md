...
<span class="tag">Python</span> <span class="tag">PyTorch</span> <span class="tag">Spark</span> <span class="tag">ABM</span>

**IEEE Publication: Cross-Domain Knowledge Transfer for Acoustic Classification**  
Invited work on transferring representations across audio/image domains for robust classification.

---

### 2024
**Data Scientist, AT&T (Intern)**  
Designed and deployed real-time fraud risk scoring API (FastAPI, AWS Lambda, Bayesian NN) serving **millions** of requests/day; anomaly detection microservice (LSTM + XGBoost) reduced late payments by **15%**.  
<span class="tag">FastAPI</span> <span class="tag">AWS</span> <span class="tag">LSTM</span> <span class="tag">XGBoost</span> <span class="tag">Spark SQL</span>

**Graduate Research & Teaching Assistant, Texas A&M**  
Researched Bayesian LSTM forecasting for geospatial yield prediction (**87%** accuracy improvement). Mentored 150+ students in ML/DSA.

**Research: MIT Lincoln Laboratory**  
Developed and benchmarked **novel DNN architectures for audio classification**; ran cross-domain experiments on distributed GPU clusters to improve audio-to-image transfer.  
<span class="tag">Novel DNNs</span> <span class="tag">GPU Clusters</span> <span class="tag">Transfer Learning</span>

---

### 2023
**M.S. Data Science, Texas A&M University – started**  
Focus on ML, DL, NLP, distributed training, optimization, scientific computing.

**Baylor Scott & White Health – GenAI Research**  
Built GAN-based synthetic ECG generators, boosting anomaly detection precision by **22%**.  
<span class="tag">GANs</span> <span class="tag">Healthcare AI</span>
...
<span class="tag">Python</span> <span class="tag">C++</span> <span class="tag">Graph ML</span> <span class="tag">Bayesian Opt</span> <span class="tag">Azure</span>

---

### 2020 – 2021
**IEEE: Longitudinal Collision Avoidance in Self-Driving Vehicles**  
Deep learning + Particle Swarm Optimization (PSO) for autonomous navigation.

---

### 2018 – 2020
**ISRO (Indian Space Research Organisation): Smart Early Warning System for Disease Outbreaks**  
Started the project in **2018** to address climate-driven rise in outbreaks. First version was **selected for INAC at ISRO in 2019** before COVID-19. After the pandemic hit, rapidly improved the system and **securely deployed** it with local orgs/govt for small-area alerts. Published the early version as an **IEEE paper in 2020**.  
<span class="tag">ISRO</span> <span class="tag">Early Warning</span> <span class="tag">Epidemiology</span> <span class="tag">Climate</span>

---

### 2017 – 2021
**B.Tech, Electronics & Telecommunication, Cummins College**  
University Gold Medalist. Specialized in Systems + ML integration.  
Core: C++, OS, DS&A, DBMS, DSP, CV, Networking.  
<span class="tag">C++</span> <span class="tag">DSA</span> <span class="tag">DBMS</span>
...
Automates feature selection for high-dimensional tabular ML, reducing compute and improving model quality.  
<span class="tag">Attention</span> <span class="tag">Feature Eng</span>
